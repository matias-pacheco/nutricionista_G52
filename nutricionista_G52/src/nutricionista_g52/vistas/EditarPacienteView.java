...
public class EditarPacienteView extends javax.swing.JInternalFrame {
    ...
    public EditarPacienteView(Paciente paciente){
        initComponents();
...
//---------- Por Defecto ----------
    private void habilitarComponenetes(boolean habilitado){
        jLabDni.setEnabled(habilitado);
        jLabJTFDni.setEnabled(habilitado);
...
//---------- Excepciones ----------
    ...
    private void initComponents() {
        ...
        jButHabilitar = new javax.swing.JButton();
        ...
        jButHabilitar.setText("Habilitar");
        jButHabilitar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButHabilitarActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(jLabJTFDni, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                            .addComponent(jTexFiDni, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGap(18, 18, 18)
                                            .addComponent(jButHabilitar, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGap(12, 12, 12))))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButHabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButHabilitarActionPerformed
        // TODO add your handling code here:
        
        habilitarComponenetes(true);
    }//GEN-LAST:event_jButHabilitarActionPerformed
    ...
    private void jButGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButGuardarActionPerformed
        ...
        try{
            ...
            Paciente pac = new Paciente(dni, apellido, nombre, domicilio, telefono, estado);
            pac.setIdPaciente(this.paciente.getIdPaciente());
            
            if(pacData.modificarPaciente(pac)){
    ...
    private void jTexFiDniKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTexFiDniKeyReleased
        ...
        try{
            ...
            if(pacData.buscarPacientePorDni(dni) && paciente.getDni() != dni){
    ...
    private void jTexFiTelefonoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTexFiTelefonoKeyReleased
        ...
        try{   
            ...
            if(pacData.buscarPacientePorTelefono(telefono) && !paciente.getTelefono().replace(" ", "").equals(
                    telefono.replace(" ", ""))){
    ...
    private javax.swing.JButton jButHabilitar;
